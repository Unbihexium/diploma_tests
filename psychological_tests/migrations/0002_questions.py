...
def forwards(apps, schema_editor):
    ...
    TailorQuestion.objects.bulk_create([
        TailorQuestion(question_text='Обычно я спокоен и вывести меня из этого состояния нелегко'),
        TailorQuestion(question_text='Мои нервы расстроены не более, чем у других людей'),
        TailorQuestion(question_text='У меня редко бывают запоры'),
        TailorQuestion(question_text='У меня редко бывают головные боли'),
        TailorQuestion(question_text='Я редко устаю'),
        TailorQuestion(question_text='Я почти всегда чувствую себя счастливым'),
        TailorQuestion(question_text='Я уверен в себе'),
        TailorQuestion(question_text='Я практически никогда не краснею'),
        TailorQuestion(question_text='Я человек смелый'),
        TailorQuestion(question_text='Я краснею не чаще, чем другие'),
        TailorQuestion(question_text='Я редко ощущаю сильное сердцебиение'),
        TailorQuestion(question_text='Обычно мои руки теплые (не очень боятся холода)'),
        TailorQuestion(question_text='Я застенчив не более, чем другие'),
        TailorQuestion(question_text='Мне не хватает чувства уверенности в своих силах'),
        TailorQuestion(question_text='Порою мне кажется, что я ни на что не годен'),
        TailorQuestion(question_text='Бывают периоды беспокойства, не могу усидеть на месте'),
        TailorQuestion(question_text='Меня часто беспокоит желудок'),
        TailorQuestion(question_text='Не хватит духа вынести предстоящие трудности'),
        TailorQuestion(question_text='Хочется быть счастливым, как другие'),
        TailorQuestion(question_text='Кажется, передо мной трудности, которые мне не преодолеть'),
        TailorQuestion(question_text='Мне снятся кошмарные сны'),
        TailorQuestion(question_text='Когда волнуюсь, дрожат руки'),
        TailorQuestion(question_text='У меня беспокойный сон, часто просыпаюсь'),
        TailorQuestion(question_text='Меня часто тревожат возможные неудачи'),
        TailorQuestion(question_text='Иногда испытываю страх, когда опасности нет'),
        TailorQuestion(question_text='Мне трудно сосредоточиться на задании'),
        TailorQuestion(question_text='Простую работу делаю часто с напряжением'),
        TailorQuestion(question_text='Я легко прихожу в замешательство'),
        TailorQuestion(question_text='Почти все время испытываю неясную тревогу'),
        TailorQuestion(question_text='Я склонен принимать всерьез даже пустяки'),
        TailorQuestion(question_text='Я часто переживаю и плачу'),
        TailorQuestion(question_text='У меня бывают приступы тошноты и рвоты'),
        TailorQuestion(question_text='Расстройство желудка у меня почти каждый месяц'),
        TailorQuestion(question_text='Я боюсь, что при волнении сильно покраснею'),
        TailorQuestion(question_text='Мне обычно трудно сосредоточиться на чем-то важном'),
        TailorQuestion(
            question_text='Меня постоянно беспокоит желание улучшить свое материальное положение, хотя оно не хуже других'),
        TailorQuestion(question_text='Нередко думаю, о чем не хотел бы поделиться с другими, стыдно'),
        TailorQuestion(question_text='Иногда из-за переживаний теряю сон'),
        TailorQuestion(question_text='Когда волнуюсь, иногда сильно потею'),
        TailorQuestion(question_text='Я иногда сильно потею, даже в холодные дни'),
        TailorQuestion(question_text='Временами из-за волнения никак не могу заснуть'),
        TailorQuestion(question_text='Я человек легко возбудимый'),
        TailorQuestion(question_text='Иногда чувствую себя бесполезным человеком'),
        TailorQuestion(question_text='Нередко из-за волнения могу легко выйти из себя'),
        TailorQuestion(question_text='Я часто ощущаю смутную тревогу'),
        TailorQuestion(question_text='Я чувствительнее многих своих товарищей'),
        TailorQuestion(question_text='Почти все время испытываю чувство голода'),
        TailorQuestion(question_text='Часто кажется, что меня преследуют болезни'),
        TailorQuestion(question_text='Часто кажется, что за мной кто-то наблюдает'),
        TailorQuestion(question_text='Ожидание всегда меня нервирует'),
    ])

    PSM25Question.objects.bulk_create([
        PSM25Question(question_text='Я напряжен и взволнован (взвинчен)'),
        PSM25Question(question_text='У меня ком в горле, и (или) я ощущаю сухость во рту'),
        PSM25Question(question_text='Я перегружен работой. Мне совсем не хватает времени'),
        PSM25Question(question_text='Я проглатываю пищу или забываю поесть'),
        PSM25Question(
            question_text='Я обдумываю свои идеи снова и снова; я меняю свои планы; мои мысли постоянно повторяются'),
        PSM25Question(question_text='Я чувствую себя одиноким, изолированным и непонятым'),
        PSM25Question(
            question_text='Я страдаю от физического недомогания; у меня болит голова, напряжены мышцы шеи, боли в спине, спазмы в желудке'),
        PSM25Question(question_text='Я поглощен мыслями, измучен или обеспокоен'),
        PSM25Question(question_text='Меня внезапно бросает то в жар, то в холод'),
        PSM25Question(question_text='Я забываю о встречах или делах, которые должен сделать или решить'),
        PSM25Question(question_text='Я легко могу заплакать'),
        PSM25Question(question_text='Я чувствую себя уставшим'),
        PSM25Question(question_text='Я крепко стискиваю зубы'),
        PSM25Question(question_text='Я не спокоен'),
        PSM25Question(question_text='Мне тяжело дышать, и (или) у меня внезапно перехватывает дыхание'),
        PSM25Question(
            question_text='Я имею проблемы с пищеварением и с кишечником (боли, колики, расстройства или запоры)'),
        PSM25Question(question_text='Я взволнован, обеспокоен или смущен'),
        PSM25Question(question_text='Я легко пугаюсь; шум или шорох заставляет меня вздрагивать'),
        PSM25Question(question_text='Мне необходимо более чем полчаса для того, чтобы уснуть'),
        PSM25Question(
            question_text='Я сбит с толку; мои мысли спутаны; мне не хватает сосредоточенности, и я не могу сконцентрировать внимание'),
        PSM25Question(question_text='У меня усталый вид; мешки или круги под глазами'),
        PSM25Question(question_text='Я чувствую тяжесть на своих плечах'),
        PSM25Question(
            question_text='Я встревожен. Мне необходимо постоянно двигаться; я не могу устоять на одном месте'),
        PSM25Question(question_text='Мне трудно контролировать свои поступки, эмоции, настроения или жесты'),
        PSM25Question(question_text='Я напряжен'),
    ])
